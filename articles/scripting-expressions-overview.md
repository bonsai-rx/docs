The `Scripting.Expressions` operators use the [expression language](https://dynamic-linq.net/expression-language) provided by the [dynamic-linq](https://dynamic-linq.net/) library.
